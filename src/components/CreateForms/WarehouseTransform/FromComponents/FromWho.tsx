...
const FromWho: React.FC<FromWhoProps> = ({ formData, setFormData }) => {
  ...
  useEffect(() => {
    if (formData.from_warehouse) {
      getResponsiblePersons(formData.from_warehouse);
    }
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-lg font-semibold">Qayerdan</h3>
        {/* Form fields */}
