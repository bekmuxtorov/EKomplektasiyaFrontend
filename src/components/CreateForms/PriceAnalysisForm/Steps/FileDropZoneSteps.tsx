    ...
    <div className="w-full max-w-md mx-auto flex flex-col items-end gap-4 justify-between">
      {!file && (
        <div
          ...
          onDrop={handleDrop}
          className={`w-full border-2 rounded-lg flex flex-col items-center gap-4 p-2 text-center transition ${isDragging ? "border-blue-500 bg-blue-50" : "border-gray-300"
            }`}
        >
      ...
      {file && (
        <div className="flex gap-2 m-auto mt-4 text-center">
