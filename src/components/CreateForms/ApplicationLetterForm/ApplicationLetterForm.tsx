...
const ApplicationLetterForm: React.FC<IPriceAnalysisFormProps> = ({ setIsCreateFormModalOpen, isCreateFormModalOpen }) => {
  ...
  // Step configuration
  const steps = [
    { title: "Tovarlar", component: AppProductsStep },
    { title: "Murojat xatini shakllantirish", component: FormingCoverLetter },
    { title: "Kelishuvchilar", component: Negotiators },
  ];
